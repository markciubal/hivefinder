    ...
    return (<header className="bg-white">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="flex lg:hidden">
          <button type="button" aria-label="Open main menu" onClick={() => setMobileOpen(true)} className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <div className="relative">
            <button ref={productBtnRef} type="button" aria-haspopup="menu" aria-expanded={desktopProductOpen} onClick={() => setDesktopProductOpen((s) => !s)} onBlur={(e) => {
            ...
            {desktopProductOpen && (<div id="desktop-menu-product" role="menu" aria-label="Product" tabIndex={-1} className="absolute z-50 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-gray-800 outline outline-1 -outline-offset-1 outline-white/10 backdrop:bg-transparent">
                <div className="p-4">
                  {/* Item */}
                ...
                <div className="grid grid-cols-2 divide-x divide-white/10 bg-gray-700/50">
                  <a href="#" className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-black hover:bg-gray-700/50">
                    <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="size-5 flex-none text-gray-500">
      ...
      {/* Mobile menu "dialog" */}
      {mobileOpen && (<div className="lg:hidden">
          <div className="fixed inset-0 z-40 bg-black/30" aria-hidden="true" onClick={() => setMobileOpen(false)}/>
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
            <div className="flex items-center justify-between">
              ...
              <button type="button" aria-label="Close menu" onClick={() => setMobileOpen(false)} className="-m-2.5 rounded-md p-2.5 text-gray-400">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" className="size-6">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-white/10">
                <div className="space-y-2 py-6">
                  <div className="-mx-3">
                    <button type="button" aria-controls="mobile-products" aria-expanded={mobileProductsOpen} onClick={() => setMobileProductsOpen((s) => !s)} className="flex w-full items-center justify-between rounded-lg py-2 pr-3.5 pl-3 text-base/7 font-semibold text-black hover:bg-white/5">
                      Product
                      <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className={`size-5 flex-none transition-transform ${mobileProductsOpen ? "rotate-180" : ""}`}>
                        <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" fillRule="evenodd"/>
                      </svg>
                    </button>

                    {mobileProductsOpen && (<div id="mobile-products" className="mt-2 space-y-2" role="group" aria-label="Product">
                        <a href="#" className="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-semibold text-black hover:bg-white/5">
                          Analytics
                        </a>
                        <a href="#" className="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-semibold text-black hover:bg-white/5">
                          Engagement
                  ...
                  <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-black hover:bg-white/5">
                    Features
                  </a>
                  <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-black hover:bg-white/5">
                    Marketplace
                ...
                <div className="py-6">
                  <a href="#" className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-black hover:bg-white/5">
                    Log in
                  </a>
                </div>
              </div>
