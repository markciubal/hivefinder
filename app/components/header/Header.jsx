    ...
    <header className="bg-white">
      ...
      >
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/club" className="text-sm/6 font-semibold text-black">
            Club
          </a>
                ...
                <div className="space-y-2 py-6">
                  <div className="-mx-3">
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-lg py-2 pr-3.5 pl-3 text-base/7 font-semibold text-black hover:bg-white/5"
                    >
                      Product
                      <svg
                        viewBox="0 0 20 20"
